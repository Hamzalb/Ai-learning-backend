...
router.post('/schools', validateZod(schemas.createSchoolSchema), ctrl.createSchool);
router.get('/schools/:id', ctrl.getSchool);
router.put('/schools/:id', validateZod(schemas.createSchoolSchema.partial()), ctrl.updateSchool);
router.patch('/schools/:id/toggle', ctrl.toggleSchoolActive);
router.delete('/schools/:id', ctrl.deleteSchool);

router.get('/users', ctrl.getUsers);
router.post('/users', validateZod(schemas.createUserSchema), ctrl.createUser);
router.get('/users/:id', ctrl.getUser);
router.put('/users/:id', validateZod(schemas.createUserSchema.partial()), ctrl.updateUser);
